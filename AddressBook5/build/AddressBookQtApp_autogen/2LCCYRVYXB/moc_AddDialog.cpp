...
Q_CONSTINIT static const qt_meta_stringdata_CLASSAddDialogENDCLASS_t qt_meta_stringdata_CLASSAddDialogENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(10, 12),  // "contactAdded"
        QT_MOC_LITERAL(23, 0),  // ""
...
void AddDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &AddDialog::contactAdded; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void AddDialog::contactAdded(const QString & _t1, const QString & _t2, const QString & _t3, const QString & _t4)
{
