...
Q_CONSTINIT static const qt_meta_stringdata_CLASSStartMenuENDCLASS_t qt_meta_stringdata_CLASSStartMenuENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(10, 16),  // "sigSignInClicked"
        QT_MOC_LITERAL(27, 0),  // ""
        QT_MOC_LITERAL(28, 16),  // "sigSignUpClicked"
        QT_MOC_LITERAL(45, 15),  // "onSignInClicked"
...
Q_CONSTINIT const QMetaObject StartMenu::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSStartMenuENDCLASS_t,
        ...
        // method 'sigSignInClicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'sigSignUpClicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void StartMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->sigSignInClicked(); break;
        case 1: _t->sigSignUpClicked(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &StartMenu::sigSignInClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (StartMenu::*)();
            if (_t _q_method = &StartMenu::sigSignUpClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void StartMenu::sigSignInClicked()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void StartMenu::sigSignUpClicked()
{
