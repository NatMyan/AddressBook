...
AddressWidget::AddressWidget(QWidget *parent) : 
    ...
    addButton(new QPushButton(tr("Add"), this)) // Initialize the QPushButton
{
    ...
    connect(addButton, &QPushButton::clicked, this, &AddressWidget::addNewEntry); // Connect the button's clicked signal to the slot
...
void AddressWidget::readFromDatabase() {
    ...
    db.setDatabaseName("address_book.db"); // SQLite database file name*/
