...
Q_CONSTINIT static const qt_meta_stringdata_CLASSNewAddressTabENDCLASS_t qt_meta_stringdata_CLASSNewAddressTabENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(44, 12),  // "sendFilePath"
        QT_MOC_LITERAL(57, 8),  // "filePath"
        QT_MOC_LITERAL(66, 8),  // "addEntry"
        QT_MOC_LITERAL(75, 9)   // "openEntry"
    },
    "NewAddressTab",
    "sendDetails",
    "",
...
void NewAddressTab::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (NewAddressTab::*)(const QString & );
            if (_t _q_method = &NewAddressTab::sendFilePath; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void NewAddressTab::sendFilePath(const QString & _t1)
{
